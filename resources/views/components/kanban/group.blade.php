...
<div {{ $attributes->whereStartsWith('wire:') }} class="flex flex-col flex-shrink-0 w-80 ring-1 bg-gray-100 dark:bg-gray-900 ring-gray-950/10 dark:ring-white/10 rounded-md">
