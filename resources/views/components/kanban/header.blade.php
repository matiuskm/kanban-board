        ...
        <div class="flex items-center justify-between py-3 border-b border-gray-950/10 dark:border-white/10">
            <div class="flex flex-1 min-w-0">
                ...
                <div class="flex-shrink-1 relative w-64 ml-3 lg:ml-0">
                    ...
                    <div class="flex rounded-lg shadow-sm ring-1 transition duration-75 bg-white dark:bg-white/5 ring-gray-950/10 dark:ring-white/20 focus-within:ring-2 focus-within:ring-amber-600 focus-within:ring-amber-500 overflow-hidden">
                        <input class="bg-white/0 block w-full rounded-md border-none text-base sm:text-sm py-2 pl-10 pr-4 sm:leading-6 text-gray-950 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus-visible:outline-none dark:focus-visible:outline-none focus:ring-0" type="text" placeholder="Search">
                    </div>
                </div>
            </div>
